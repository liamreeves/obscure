export const words = {
  a: {
    ...
    aimonomia:
      "fear that learning the name of something—a bird, a constellation, an attractive stranger—will somehow ruin it, transforming a lucky discovery into a conceptual husk pinned in a glass case, which leaves one less mystery to flutter around your head, trying to get in.",
    altschmerz:
    ...
    ameneurosis:
      "the half-forlorn, half-escapist ache of a train whistle calling in the distance at night.",
    anchorage:
    ...
    anthrodynia:
      "a state of exhaustion with how shitty people can be to each other, typically causing a countervailing sense of affection for things that are sincere but not judgmental, are unabashedly joyful, or just are.",
    apomakrysmenophobia:
  ...
  e: {
    ...
    ellipsism:
      "sadness that you'll never be able to know how history will turn out, that you'll dutifully pass on the joke of being alive without ever learning the punchline—the name of the beneficiary of all human struggle, the sum of the final payout of every investment ever made in the future—which may not suit your sense of humor anyway and will probably involve how many people it takes to change a lightbulb.",
    énouement:
  ...
  f: {
    ...
    Funkenzwangsvorstellung:
      "the instinctive trance of a campfire in the dark, spending hours roasting and watching as it settles and sinks into the ground like a heap of shipwrecks whose sailors raise their flickering sails trying to signal that the prevailing winds of your life are about to shift, that the edge of the Earth is real and looming just a few years ahead, and that your marshmallow is on fire.",
  },
  g: {
    "la gaudière":
  ...
  k: {
    ...
    "the kinda blues":
      "the sad awareness that the unfolding plot of your life feels new and profound but is not unique, just one of a few dozen possible riffs on the same chord progression, while the tunes reverberating from the jukebox in your chest are all covers of old standards from the Great Emotional Songbook, which is 98% identical to that of the chimpanzee.",
    kuebiko:
  ...
  l: {
    ...
    lalalalia:
      "the realization while talking to yourself that someone else is within earshot, which leads you to crossfade into mumbled singing, an auditory sleight of hand that distracts the audience from the exposed platform under your persona while you prepare to saw your confidence in half.",
    lapyear:
      "the age at which you become older than your parents were when you were born, which signals that your leg of the relay race has already begun, having coasted in their slipstream as they tackled the mountain stages of life, leaving you strong, energetic and deeply mortified by their loud yellow jerseys.",
    lethobenthos:
    ...
    lilo: "a friendship that can lie dormant for years only to pick right back up instantly, as if no time had passed since you last saw each other.",
  },
  m: {
    mahpiohanzia:
      "the disappointment of being unable to fly, unable to stretch out your arms and vault into the air, having finally shrugged off the ballast of your own weight and ignited the fuel tank of unfulfilled desires you've been storing up since before you were born.",
    "mal de coucou":
  ...
  p: {
    pâro: "The feeling that no matter what you do, it is always somehow wrong. It is as if any attempt to make your way comfortably through the world will only end up crossing some invisible taboo. It feels like there is an obvious way forward that everybody else can see, but you cannot. Each of them leans back in their chair and calls out helpfully, 'colder, colder, colder.'",
  },
  r: {
    "reverse shibboleth":
  ...
  s: {
    ...
    "swish fulfillment":
      "the feeling of delicate luck after casually tossing something across the room and hitting your target so crisply and perfectly that you feel no desire to even attempt another shot, which is a more compelling argument for the concept of monogamous love than anything sung to a guitar.",
  },
  t: {
    "the tilt shift":
